        ...
        <>
                ...
                awardsignal ? <>
                    <div className='custom-toast '>
                        <div className='pb-10 flex flex-col gap-3 bg-[#fefefe]  w-[300px] md:w-2/4 text-start toaster rounded-xl shadow-xl p-5 z-10'>
                            <RxCrossCircled onClick={() => { setAwardsignal(false) }} className='ml-auto' />
            ...
            }
            {
                newPartnershipsig ? <>
                    <div className='custom-toast '>
                        <div className='pb-10 flex flex-col gap-3 bg-[#fefefe]  w-[300px] md:w-2/4 text-start toaster rounded-xl shadow-xl p-5 z-10'>
                            <RxCrossCircled onClick={() => { setNewpartnershipsig(false) }} className='ml-auto' />
            ...
            }
            {
                newproductsig ? <>
                    <div className='custom-toast '>
                        <div className='pb-10 flex flex-col gap-3 bg-[#fefefe]  w-[300px] md:w-2/4 text-start toaster rounded-xl shadow-xl p-5 z-10'>
                            <RxCrossCircled onClick={() => { setNewproductsig(false) }} className='ml-auto' />
            ...
            <div className='flex flex-col gap-1 shadow-xl bg-[#fff] p-3 md:p-5 rounded-xl'>
                ...
                <div className='bg-[#F5F5F5] p-4 rounded-xl flex gap-3 w-full'>
                    ...
                    <div className='w-full'>
                        <div className='flex justify-between w-full items-center'>
                            <h2 onClick={()=>{setAwardsignal(true)}} className='cursor-pointer text-[14px] sm:text-[15px] xl:text-[16px] font-semibold font-poppins text-[#030621]'>Award or recognition</h2>
                ...
                <div className=' p-4 rounded-xl flex gap-3 w-full'>
                    ...
                    <div className='w-full'>
                        <div className='flex justify-between w-full items-center'>
                            <h2 onClick={()=>{setNewpartnershipsig(true)}}  className='cursor-pointer text-[14px] sm:text-[15px] xl:text-[16px] font-semibold font-poppins text-[#030621]'>New Partnership</h2>
                            <FaChevronRight className='text-[#030621]' />
                        </div>
                        <h4 className='text-[13px] sm:text-[14px] xl:text-[15px] font-normal font-poppins text-[#7B7B7B]'>Recognition = Recognition +1</h4>
                ...
                <div className='bg-[#F5F5F5] p-4 rounded-xl flex gap-3 w-full'>
                    ...
                    <div className='w-full'>
                        <div className='flex justify-between w-full items-center'>
                            <h2 onClick={()=>{setNewproductsig(true)}}  className='cursor-pointer text-[14px] sm:text-[15px] xl:text-[16px] font-semibold font-poppins text-[#030621]'>New product or service</h2>
                            <FaChevronRight className='text-[#030621]' />
                        </div>
