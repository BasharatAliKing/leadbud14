...
export default function Companies({
  ...
  const handleIconClickcompany = () => {
    ...
    setIsEditablewebsite(false);
    setIsEditabejobp(false);
    setIsEditablehqphone(false);
    setCompPrevval(true);
    ...
    <>
      <div className="p-2 flex flex-col hover:bg-[#F5F5F5] duration-300 gap-3 md:gap-0 rounded-md ">
        <div className="flex gap-2 md:gap-0 ">
          <h2 className="text-[13px] w-[150px] mt-[6px] font-normal font-poppins">
            Company:
          </h2>
          <div
            onClick={() => {
          ...
          >
            {compprevval ? (
              <div className="flex items-center gap-1">
                ...
                <h2 className="text-[12px]">
                  {companyValue?.length > 0 ? companyValue : "---"}
                </h2>
                <RiDeleteBin5Line
                  onClick={() => {
                    setCompany("");
            ...
            <div className="flex relative items-center w-full">
              ...
              {hovercompany ? (
                <PiPencilLight
                  onClick={handleIconClickcompany}
      ...
      <div className="p-2 flex gap-3 md:gap-0 hover:bg-[#F5F5F5] duration-300 rounded-md items-center">
        <h2 className="text-[13px] w-[150px] font-normal font-poppins">
          Job Position:
        </h2>
        <div
          onClick={() => {
        ...
        >
          {jobpprevval ? (
            <div className="flex items-center gap-1">
              <div className="w-[10px] h-[10px] bg-green rounded-full"></div>
              <h2 className="text-[12px]">
                {jobPositionValue?.length > 0 ? jobPositionValue : "---"}
              </h2>
              <RiDeleteBin5Line
                onClick={() => {
                  setJobp("");
          ...
          <div className="flex relative items-center w-full">
            <input
              ref={inputRefjobposition}
              type="text"
              disabled={!isEditablejobp}
              placeholder="---"
              value={jobp}
              onChange={(e) => {
                setJobp();
            ...
            {hoverjobp ? (
              <PiPencilLight
                onClick={handleIconClickjobposition}
                className=" top-[8px] text-[14px] absolute right-[2px]"
              />
            ) : null}
          </div>
      ...
      <div className="p-2 flex items-center hover:bg-[#F5F5F5] duration-300 gap-3 md:gap-0 ">
        ...
        <div
          ...
          className=" flex flex-col gap-1 w-full"
          onMouseEnter={() => {
            setHoverwebsite(true);
          }}
          onMouseLeave={() => {
            setHoverwebsite(false);
          }}
        >
          {websiteprevval ? (
            <div className="flex items-center gap-1">
              <div className="w-[10px] h-[10px] bg-green rounded-full"></div>
              <h2 className="text-[12px]">
                {websiteValue?.length ? websiteValue : "---"}
              </h2>
              <RiDeleteBin5Line
                onClick={() => {
                  setWebsite("");
          ...
          <div className="flex items-center relative w-full">
            ...
            {hoverwebsite ? (
              <PiPencilLight
                onClick={handleIconClickwebsite}
                className=" top-[8px] text-[14px] absolute right-[2px]"
              />
            ) : null}
          </div>
      ...
      <div className="p-2 flex items-center gap-3 md:gap-0 hover:bg-[#F5F5F5] duration-300 rounded-md">
        ...
        <div
          ...
          onMouseEnter={() => {
            setHoverhqphone(true);
          }}
          onMouseLeave={() => {
            setHoverhqphone(false);
          }}
        >
          {hqphoneprevval ? (
            <div className="flex items-center gap-1">
              <div className="w-[10px] h-[10px] bg-green rounded-full"></div>
              <h2 className="text-[12px]">
                {hqPhoneValue?.length > 0 ? hqPhoneValue : "---"}
              </h2>
              <RiDeleteBin5Line
                onClick={() => {
                  setHqphone("");
          ...
          <div className="flex relative w-full items-center">
            ...
            {hoverhqphone ? (
              <PiPencilLight
                onClick={handleIconClickhqphone}
                className=" top-[8px] text-[14px] absolute right-[2px]"
              />
            ) : null}
          </div>
        ...
        <div className="flex left-0 pl-16 sm:pl-20 z-[1] md:pl-24 p-2 py-4  w-full  md:w-[443px] bottom-0 bg-[#F5F5F5] fixed gap-3 ">
          ...
          <button
            onClick={() => {
              ...
              setJobp(jobPositionValue);
              setWebsite(websiteValue);
              setHqphone(hqPhoneValue);
            }}
