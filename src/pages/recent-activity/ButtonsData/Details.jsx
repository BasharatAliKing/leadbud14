               ...
               <div className='custom-toast'>
                  <div className=' flex flex-col gap-1 bg-[#fefefe]  w-[300px] md:w-[400px] toaster rounded-xl shadow-xl p-5 z-10'>
                     ...
                     <div className="flex gap-3 justify-center w-full mt-3">
                        <button onClick={() => { setCanceltoast(false); setSaveCompanyBtn(false) }} className="bg-gradient-to-r from-[#56F444] via-[#55EE44] to-[#48FA8A]  rounded-md text-[#000] text-[13px] xl:text-[15px] p-2 px-3">Revert Changes</button>
                        <button onClick={() => { setCanceltoast(false) ; setSaveCompanyBtn(false) }} className="bg-[#d7d7d7] rounded-md text-[13px] xl:text-[15px] p-2 px-3">Cancellllll</button>
                     </div>
                  </div>
               </div>
            </> : null
