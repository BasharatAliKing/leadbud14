...
export default function Details() {
  ...
  const updateCompanyData = () => {
    setCompaniesArrayData((prevCompaniesArrayData) => {
      return prevCompaniesArrayData.map((company, i) =>
        i === temData.objectIndex
          ? {
              company: temData?.company,
              jobPosition: temData?.jobp,
              website: temData?.website,
              hqPhone: temData?.hqphone,
            }
          : company
      );
    });
  ...
  const handleIconClick = () => {
    ...
    setIsEditableindustry(false);
    setIsEditablecountry(false);
    setIsEditabelocation(false);
    setIsEditabework(false);
    setIsEditabepersonal(false);
    setEmailprev(true);
    setIndustryPrevval(false);
    setCountryPrevval(false);
    setLocationPrevval(false);
    setWorkPrevval(false);
    setPersonalPrevval(false);
    setTimeout(() => {
        ...
        <>
          <div className="custom-toast">
            <div className=" flex flex-col gap-1 bg-[#fefefe]  w-[300px] md:w-[400px] toaster rounded-xl shadow-xl p-5 z-10">
              ...
              <h3 className="text-[16px] md:text-[18px] text-[#000] font-medium ">
                Unsaved Changes
              </h3>
              <p className="text-[12px]">
                Are you sure you want to revert new changes in this prospect
                file ? All unsaved changes will be lost
              </p>
              <div className="flex gap-3 justify-center w-full mt-3">
                <button
                  onClick={() => {
                    setSavebtn(false);
                    setEmail("tina.z@snov-cctv.io");
                    setIndustry("Electric & Electronic");
                    setCountry("China");
                    setLocation("China");
                  ...
                  className="bg-gradient-to-r from-[#56F444] via-[#55EE44] to-[#48FA8A]  rounded-md text-[#000] text-[13px] xl:text-[15px] p-2 px-3"
                >
                  Revert Changes
                </button>
                <button
                  ...
                  className="bg-[#d7d7d7] rounded-md text-[13px] xl:text-[15px] p-2 px-3"
                >
                  Cancel
                </button>
              </div>
      ...
      {savebtn ? (
        <div className="flex left-0 pl-16 sm:pl-20 z-[1] md:pl-24 p-2 w-full  md:w-[443px] bottom-0 bg-[#F5F5F5] fixed gap-3 ">
          ...
          <button
            ...
            className="bg-[#fff] rounded-md text-[13px] xl:text-[15px] p-2 px-3"
          >
            Cancel
          </button>
        </div>
      ...
      <div className="flex flex-col gap-4">
        <div className="">
          <div className="p-2 flex gap-2 hover:bg-[#F5F5F5] duration-300 md:gap-0 items-center ">
            <h2 className="text-[13px] w-[100px] font-normal font-poppins">
              Email:
            </h2>
            <div
              onClick={() => {
            ...
            >
              ...
              <div className="flex items-center w-full relative">
                <input
                  ...
                  className="bg-[#0000] text-[13px] border-0 focus:border focus:outline-none p-1 rounded-md font-normal font-poppins text-[#030621] w-full"
                />
                {hover ? (
                  <PiPencilLight
                    onClick={handleIconClick}
                    className=" top-[8px] text-[14px] absolute right-[2px]"
                  />
                ) : null}
              </div>{" "}
            </div>
          ...
          <div className="p-2 flex flex-col  gap-2 md:gap-0 hover:bg-[#F5F5F5] duration-300 rounded-md">
            <div className="flex gap-2 md:gap-0">
              <h2 className="text-[13px] w-[100px] mt-2 font-normal font-poppins">
                Industry:
              </h2>
              <div
                onClick={() => {
                ...
                onMouseEnter={() => {
                  setHoverindustry(true);
                }}
                onMouseLeave={() => {
                  setHoverindustry(false);
                }}
              >
                {industryprevval ? (
                ...
                <div className="relative flex items-center w-full">
                  <input
                    ...
                    type="text"
                    disabled={!isEditableindustry}
                    value={industry}
                    onChange={handleemailchange}
                    className=" border-0 focus:border focus:outline-none bg-[#fff] text-[13px] p-1 rounded-md outline-none bg-[#0000] font-normal font-poppins text-[#030621] w-full"
                  />
                  {hoverindustry ? (
                    <PiPencilLight
                      onClick={handleIconClickindustry}
                      className=" top-[8px] text-[14px] absolute right-[2px]"
                    />
                  ) : null}
                </div>
            ...
            {filteredSuggestions.length > 0 && (
              <ul className="absolute mt-16  bg-[#fff] z-10 w-full ml-[70px] cursor-pointer  rounded-md ">
                {filteredSuggestions.map((suggestion, index) => (
                  <li
                    className="hover:bg-[#F5F5F5] duration-700 p-1 px-3 text-[14px]"
                    key={index}
          ...
          <div className="p-2 flex gap-2 hover:bg-[#F5F5F5] duration-300 md:gap-0 items-center  ">
            ...
            <div
              ...
              className="flex flex-col gap-1 w-full"
              onMouseEnter={() => {
                setHovercountry(true);
              }}
              onMouseLeave={() => {
                setHovercountry(false);
              }}
            >
              {countryprevval ? (
                <div className="flex items-center gap-1">
              ...
              <div className="relative flex items-center ">
                ...
                {hovercountry ? (
                  <PiPencilLight
                    onClick={handleIconClickcountry}
                    className=" top-[8px] text-[14px] absolute right-[2px]"
                  />
                ) : null}
              </div>
            ...
            <>
              ...
              <div className="p-2 flex hover:bg-[#F5F5F5] duration-300 gap-2 md:gap-0 items-center rounded-md">
                ...
                <div
                  ...
                  className="flex flex-col gap-1 w-full"
                  onMouseEnter={() => {
                    setHoverpersonal(true);
                  }}
                  onMouseLeave={() => {
                    setHoverpersonal(false);
                  }}
                >
                  {personalprevval ? (
                    <div className="flex items-center gap-1">
                  ...
                  <div className="flex relative items-center w-full">
                    ...
                    {hoverpersonal ? (
                      <PiPencilLight
                        onClick={handleIconClickpersonal}
                        className=" top-[8px] text-[14px] absolute right-[2px]"
                      />
                    ) : null}
                  </div>
          ...
          <p
            ...
            className="text-center text-[14px] font-normal cursor-pointer mt-2 text-[#56f444]"
          >
            {showmoretext}
          </p>
        </div>
          ...
          {companiesArrayData.map((val, index) => {
            return (
              <Companies
                ...
                handleCompanybtn={handleCompanySaveBtn}
                updateData={(company, website, jobp, hqphone, objectIndex) => {
                  settemData({ company, website, jobp, hqphone, objectIndex });
                }}
                key={index}
                objectIndex={index}
                companyValue={val.company}
                websiteValue={val.website}
                jobPositionValue={val.jobPosition}
                hqPhoneValue={val.hqPhone}
