            ...
            <Layout>
              ...
              <div className='main-body  flex flex-col gap-10'>
                    <div className='flex p-5 shadow-xl rounded-lg w-full flex-col lg:flex-row gap-5 lg:gap-3'>
                        <div className='lg:w-[60%] flex flex-col gap-3 sm:gap-4'>
                            <div className='flex flex-col md:flex-row gap-2 w-full'>
                                ...
                                <div className='flex gap-1 items-center sm:mt-6 w-full'>
                        ...
                        <div className='lg:w-[40%] p-5 bg-[#F5F5F5] rounded-md flex flex-col sm:flex-row gap-5 items-center w-full'>
                            ...
                            <div className='w-full flex flex-col gap-2'>
                                <div className='flex w-full items-center '>  <h3 className='text-[#030621] text-[14px] font-normal'>Facebook Fanpage</h3> <h4 className='font-bold text-[18px] text-[#000] ml-auto'>XXXX</h4> </div>
                                <div className='flex w-full items-center '>  <h3 className='text-[#030621] text-[14px] font-normal'>Total Posts Found</h3> <h4 className='font-bold text-[18px] text-[#000] ml-auto'>XXXX</h4> </div>
                                <div className='flex w-full items-center '>  <h3 className='text-[#030621] text-[14px] font-normal'>Total Leads Found</h3> <h4 className='font-bold text-[18px] text-[#000] ml-auto'>XXXX</h4> </div>
                            </div>
                        </div>
                    </div>
